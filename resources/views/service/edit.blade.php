    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" action="{{ route('service.update',$info->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-label-group">
                                    <input type="text" required autofocus class="form-control" placeholder="اسم الخدمه" name="name" value="{{ old('name',$info->name) }}">
                                    <label for="first-name-floating">اسم الخدمه</label>
                                    @error('name')
