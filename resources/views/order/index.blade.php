                                            ...
                                            <table class="table zero-configuration" id="datatable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td>{{ $info->student->service->name}}</td>
                                                                        ...
                                                                        <form action="{{ route('orders.update_status',$info->id) }}" method="POST">
                                                                            ...
                                                                            <fieldset class="form-group">
                                                                                <select class="form-control" id="basicSelect" name="status">
                                                                                    <option value="0" {{ $info->status == 0 ? 'selected' : '' }}>جديد</option>
                                                                                    <option value="1" {{ $info->status == 1 ? 'selected' : '' }}>قيد التوصيل</option>
                                                                                    <option value="2" {{ $info->status == 2 ? 'selected' : '' }}>مكتمل</option>
                                                                                    <option value="3" {{ $info->status == 3 ? 'selected' : '' }}>ملغي</option>
                                                                                </select>
                                                                            </fieldset>
                                                                        </div>
                                                                        <div class="modal-footer">
